    ...
    return (
        <div className="flex flex-col items-center min-h-screen text-white font-montserrat m-0 p-0 w-75 max-w-3xl mx-auto">
            ...
            <div className="rounded-lg bg-gradient-to-r from-custom-pink via-custom-red to-custom-yellow p-1 mb-6 w-full shadow-custom">
                <div className="flex items-start rounded-lg bg-black bg-opacity-60 mx-auto p-3 w-full backdrop-blur">
                    <img
                    ...
                    <div className="text-left">
                        ...
                        <div className="flex items-center">
                            ...
                            {displayedUserProfile.age && <p className="font-regular text-xl">, {displayedUserProfile.age}</p>}
                        </div>
                        {/* Modified part ends here */}
                        <div>
                            <div className="inline-block bg-gradient-to-r from-custom-pink via-custom-red to-custom-yellow text-white text-xs font-semibold rounded-full mt-2 p-1 pl-2 pr-2 shadow-smaller mr-2">
                                <p>Flirty</p>
                            </div>
                            <div className="inline-block bg-gradient-to-r from-custom-pink via-custom-red to-custom-yellow text-white text-xs font-semibold rounded-full mt-2 p-1 pl-2 pr-2 shadow-smaller mr-2">
                                <p>Submissive</p>
