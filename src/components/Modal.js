  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-zinc-900 p-5 w-11/12 max-w-md relative">
        ...
        <h2 className="text-white font-montserrat text-center font-bold text-2xl mb-2">
          Early Sign-Up
        </h2>
        ...
        {!isValid && !emailSubmitted && (
          <p className="text-red-500 text-sm text-center font-montserrat">
            {errorMessage}
          </p>
        )}
        {emailSubmitted && (
        ...
        <button
          ...
          className="btn-default w-full overflow-hidden relative text-white py-2 px-6 rounded-full font-bold text-base tracking-wider mt-2 transition-all duration-200 shadow-custom  bg-gradient-to-r from-custom-pink to-custom-red hover:-translate-y-[2px]"
