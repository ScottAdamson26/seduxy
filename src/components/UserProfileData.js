...
const userProfiles = [
  ...
  { id: 6, name: 'Emma', age: 31, imageUrl: lucieImage, bio: 'Emma, a dedicated nurse, provides care with compassion and resilience.', tags: ['Compassionate', 'Dedicated', 'Resilient'] },
  { id: 7, name: 'Amelia', age: 29, imageUrl: lucieImage, bio: 'Amelia, an adventurous traveler, seeks the stories hidden in uncharted lands.', tags: ['Adventurous', 'Storyteller', 'Explorer'] },
  { id: 8, name: 'Erin', age: 24, imageUrl: lucieImage, bio: 'Erin, a gifted musician, expresses her soul through the strings of her violin.', tags: ['Musical', 'Expressive', 'Gifted'] },
  { id: 9, name: 'Connie', age: 18, imageUrl: lucieImage, bio: 'Connie, a fearless skateboarder, rides the edge between adrenaline and freedom.', tags: ['Fearless', 'Adventurous', 'Skateboarder'] },
  { id: 10, name: 'Amy', age: 22, imageUrl: lucieImage, bio: 'Amy, a keen astronomer, gazes at the stars, dreaming of distant worlds.', tags: ['Astronomer', 'Dreamer', 'Curious'] },
];
